...
public class ExchangeInstrumentBuilder {
	...
	public static final org.drip.product.govvie.TreasuryFutures TreasuryFutures (
		...
		final double[] adblFuturesComponentConversionFactor)
	{
		/* if (null == strFuturesCode) return null;

		if ("CN1".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "CAN", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "10Y");

		if ("DU1".equalsIgnoreCase (strFuturesCode) || "SCHATZ".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "DBR", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "2Y");

		if ("FBB1".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "SPGB", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "10Y");

		if ("FV1".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "UST", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "5Y");

		if ("G1".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "GILT", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "10Y");

		if ("IK1".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "BTPS", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "10Y");

		if ("JB1".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "JGB", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "10Y");

		if ("OAT1".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "FRTR", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "10Y");

		if ("OE1".equalsIgnoreCase (strFuturesCode) || "BOBL".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "DBR", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "5Y");

		if ("RX1".equalsIgnoreCase (strFuturesCode) || "BUND".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "DBR", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "10Y");

		if ("TU1".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "UST", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "2Y");

		if ("TY1".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "UST", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "10Y");

		if ("UB1".equalsIgnoreCase (strFuturesCode) || "BUXL".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "DBR", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "30Y");

		if ("ULTRA".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "UST", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "30Y");

		if ("US1".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "UST", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "20Y");

		if ("WB1".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "GILT", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "2Y");

		if ("XM1".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "AGB", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "10Y");

		if ("YM1".equalsIgnoreCase (strFuturesCode))
			return TreasuryFutures (dtSpot, "AGB", aiFuturesComponentTreasuryEffectiveDate,
				aiFuturesComponentTreasuryMaturityDate, adblFuturesComponentTreasuryCoupon,
					adblFuturesComponentConversionFactor, "NOTE", "3Y"); */
